...
The authoritative retained candidate is **Beta Candidate run #180 (`35490961721`)**, artifact `DragonDiskForge-0.5.0-beta.1-win-x64-candidate-35490961721`, built from `main` commit `260dfc386339f2ccf937918272ed2af844ef5492`. The nested package SHA-256 is `af41c0600e89639a9f51e06b39e185b9942ac140c1651dbf069484fbb9dc71b9`; the GitHub artifact SHA-256 is `ccd6e11704522a5636cc5f72188260d4edc5223436ef972cdcf58dc5aaedfb8c`.

Independent artifact read-back verified every supplied SHA-256 sidecar, package manifest schema 6, x64 architecture, `.NET=self-contained`, `WindowsAppSDK=self-contained`, `VisualCpp=app-local`, exactly one desktop executable, no PDB payloads, the desktop entry-point hash `49ab87adac4d1deae3693ce8eaad61d67dd68733c81926a34ca06220a9564028`, the packaged manual-QA-tool hash `525f632943ece5e2ae72ca350015bab49d2a8149a54aa98e9a8e1fd1788a6d94`, the packaged UAC-witness-tool hash `19897638afa6015b94355927ae07001b9ae6750242e510339966f0a2d288e431` and the packaged UAC before/after pair-verifier hash `e3e7f08cb278bf35e38bc425e5b4006f9da90da18a8bef2e718363b190833500`.
