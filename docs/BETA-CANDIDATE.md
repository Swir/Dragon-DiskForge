...
The authoritative retained candidate is **Beta Candidate run #257 (`35955280508`)**, artifact `DragonDiskForge-0.5.0-beta.1-win-x64-candidate-35955280508`, built from `main` commit `9090dd6fa1f5ca4fecb81de34844ca86835a196a`. The nested package SHA-256 is `9befc753065958b4cd8399a7bba0dec43a7087f3d05dd0cbfd25f9217ad26aec`; the GitHub artifact SHA-256 is `9195104fc921749ff1ff5979354e46e41ea0bedc3e0fd2f0fecfc87ae7c54ee6`.

Independent artifact read-back verified every supplied SHA-256 sidecar, package manifest schema 6, x64 architecture, `.NET=self-contained`, `WindowsAppSDK=self-contained`, `VisualCpp=app-local`, exactly one desktop executable, no PDB payloads, the desktop entry-point hash `72be005878becc6f330c335e96f0228d26a7e40fddd5959557cac15132c7fe71`, the packaged manual-QA-tool hash `525f632943ece5e2ae72ca350015bab49d2a8149a54aa98e9a8e1fd1788a6d94`, the packaged UAC-witness-tool hash `19897638afa6015b94355927ae07001b9ae6750242e510339966f0a2d288e431` and the packaged UAC before/after pair-verifier hash `e3e7f08cb278bf35e38bc425e5b4006f9da90da18a8bef2e718363b190833500`.
